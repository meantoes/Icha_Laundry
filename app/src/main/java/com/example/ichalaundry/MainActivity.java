...
import com.example.ichalaundry.CuciBasahActivity;
import com.example.ichalaundry.DryCleanActivity;
import com.example.ichalaundry.HistoryActivity;
import com.example.ichalaundry.R;
import com.example.ichalaundry.IronActivity;
import com.example.ichalaundry.PremiumWashActivity;
import com.example.ichalaundry.MainViewModel;
    ...
    private void setMenu() {
        ...
        menuAdapter.setOnItemClickListener(modelMenu -> {
            if (modelMenu.getTvTitle().equals("Cuci Basah")) {
                ...
                Intent intent = new Intent(new Intent(MainActivity.this, IronActivity.class));
                intent.putExtra(IronActivity.DATA_TITLE, modelMenu.getTvTitle());
                startActivity(intent);
            }
        });
    }
